...
START_TEST(floor_fn) {
  ck_assert(!precision_check(s21_floor(1.5), floor(1.5)));
  ck_assert(!precision_check(s21_floor(0.45), floor(0.45)));
  ck_assert(!precision_check(s21_floor(4), floor(4)));
  ck_assert(!precision_check(s21_floor(0.000001), floor(0.000001)));
  ck_assert(!precision_check(s21_floor(-3.01), floor(-3.01)));
  ck_assert(!precision_check(s21_floor(-0.24), floor(-0.24)));
  ck_assert(!precision_check(s21_floor(0.0), floor(0.0)));
  ck_assert(!precision_check(s21_floor(-1.5), floor(-1.5)));
  ck_assert(!precision_check(s21_floor(1.99), floor(1.99)));
  ck_assert(!precision_check(s21_floor(6.75), floor(6.75)));
  ck_assert(!precision_check(s21_floor(-1.0), floor(-1.0)));
  ck_assert(!precision_check(s21_floor(2.0), floor(2.0)));
  ck_assert(!precision_check(s21_floor(2), floor(2)));
  ck_assert(!precision_check(s21_floor(5), floor(5)));
...
START_TEST(s21_floor_inf) {
  // INF
  ck_assert(!precision_check(s21_floor(S21_INF), floor(S21_INF)));
...
START_TEST(s21_floor_nan) {
  // NAN
  ck_assert(!precision_check(s21_floor(S21_NAN), floor(S21_NAN)));
