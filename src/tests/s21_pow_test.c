...
START_TEST(s21_pow_two_point_five_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(2.5, S21_INF), pow(2.5, S21_INF)));
...
START_TEST(s21_pow_two_point_five_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(2.5, S21_NAN), pow(2.5, S21_NAN)));
...
START_TEST(s21_pow_inf_two_point_five) {
  // INF
  ck_assert(!precision_check(s21_pow(S21_INF, 2.5), pow(S21_INF, 2.5)));
...
START_TEST(s21_pow_nan_two_point_five) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, 2.5), pow(S21_NAN, 2.5)));
...
START_TEST(s21_pow_two_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(2, S21_INF), pow(2, S21_INF)));
...
START_TEST(s21_pow_two_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(2, S21_NAN), pow(2, S21_NAN)));
...
START_TEST(s21_pow_inf_two) {
  // INF
  ck_assert(!precision_check(s21_pow(S21_INF, 2), pow(S21_INF, 2)));
...
START_TEST(s21_pow_nan_two) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, 2), pow(S21_NAN, 2)));
...
START_TEST(s21_pow_one_point_five_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(1.5, S21_INF), pow(1.5, S21_INF)));
...
START_TEST(s21_pow_one_point_five_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(1.5, S21_NAN), pow(1.5, S21_NAN)));
...
START_TEST(s21_pow_inf_one_point_five) {
  // INF
  ck_assert(!precision_check(s21_pow(S21_INF, 1.5), pow(S21_INF, 1.5)));
...
START_TEST(s21_pow_nan_one_point_five) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, 1.5), pow(S21_NAN, 1.5)));
...
START_TEST(s21_pow_one_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(1, S21_INF), pow(1, S21_INF)));
...
START_TEST(s21_pow_one_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(1, S21_NAN), pow(1, S21_NAN)));
...
START_TEST(s21_pow_inf_one) {
  // INF
  ck_assert(!precision_check(s21_pow(S21_INF, 1), pow(S21_INF, 1)));
...
START_TEST(s21_pow_nan_one) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, 1), pow(S21_NAN, 1)));
...
START_TEST(s21_pow_zero_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(0, S21_INF), pow(0, S21_INF)));
...
START_TEST(s21_pow_zero_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(0, S21_NAN), pow(0, S21_NAN)));
...
START_TEST(s21_pow_inf_zero) {
  // INF
  ck_assert(!precision_check(s21_pow(S21_INF, 0), pow(S21_INF, 0)));
...
START_TEST(s21_pow_nan_zero) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, 0), pow(S21_NAN, 0)));
...
START_TEST(s21_pow_zero_neg_inf) {
  // INF
  ck_assert(!precision_check(s21_pow(-0.0, S21_INF), pow(-0.0, S21_INF)));
  // ck_assert_ldouble_eq(pow(-0, S21_INF), s21_pow(-0, S21_INF));
}
END_TEST
...
START_TEST(s21_pow_zero_neg_nan) {
  // NAN
  ck_assert(!precision_check(s21_pow(-0.0, S21_NAN), pow(-0.0, S21_NAN)));
  // ld_bits check = {pow(-0, S21_NAN)};
  // ld_bits result = {s21_pow(-0, S21_NAN)};
  // for (int i = 0; i < 5; ++i) ck_assert_uint_eq(check.bits[i], result.bits[i]);
}
...
START_TEST(s21_pow_inf_zero_neg) {
  // 0.0
  ck_assert(!precision_check(s21_pow(S21_INF, -0.0), pow(S21_INF, -0.0)));
  // ck_assert_ldouble_eq(pow(S21_INF, -0), s21_pow(S21_INF, -0));
}
END_TEST
...
START_TEST(s21_pow_nan_zero_neg) {
  // NAN
  ck_assert(!precision_check(s21_pow(S21_NAN, -0.0), pow(S21_NAN, -0.0)));
  // ld_bits check = {pow(S21_NAN, -0)};
  // ld_bits result = {s21_pow(S21_NAN, -0)};
  // for (int i = 0; i < 5; ++i) ck_assert_uint_eq(check.bits[i], result.bits[i]);
}
