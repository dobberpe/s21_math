...
START_TEST(fabs_fn) {
  ck_assert(!precision_check(s21_fabs(-612367.54783), fabs(-612367.54783)));
  ck_assert(!precision_check(s21_fabs(-45.345), fabs(-45.345)));
  ck_assert(!precision_check(s21_fabs(1.0), fabs(1.0)));
...
START_TEST(s21_fabs_inf) {
  // INF
  ck_assert(!precision_check(s21_fabs(S21_INF), fabs(S21_INF)));
...
START_TEST(s21_fabs_nan) {
  // NAN
  ck_assert(!precision_check(s21_fabs(S21_NAN), fabs(S21_NAN)));
  // ld_bits check = {fabs(S21_NAN)};
  // ld_bits result = {s21_fabs(S21_NAN)};
  // for (int i = 0; i < 5; ++i)  ck_assert_uint_eq(check.bits[i], result.bits[i]);
}
...
START_TEST(s21_fabs_fn) {
  ck_assert(!precision_check(s21_fabs(-612367.54783), fabs(-612367.54783)));
  ck_assert(!precision_check(s21_fabs(-45.345), fabs(-45.345)));
  ck_assert(!precision_check(s21_fabs(68845.345), fabs(68845.345)));
  ck_assert(!precision_check(s21_fabs(1.0), fabs(1.0)));
  ck_assert(!precision_check(s21_fabs(-1.1515), fabs(-1.1515)));
  ck_assert(!precision_check(s21_fabs(0.0), fabs(0.0)));
  ck_assert(!precision_check(s21_fabs(-0.0), fabs(-0.0)));
