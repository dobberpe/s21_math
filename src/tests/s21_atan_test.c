...
START_TEST(atan_09) {
  for (double i = 0.9; i > -1; i -= 0.4) {
    ck_assert(!precision_check(s21_atan(i), atan(i)));
...
START_TEST(atan_2) {
    ck_assert(!precision_check(s21_atan(0.99999999), atan(0.99999999)));
    ck_assert(!precision_check(s21_atan(-0.99999999), atan(-0.99999999)));
...
START_TEST(atan_1) {
    ck_assert(!precision_check(s21_atan(1), atan(1)));
    ck_assert(!precision_check(s21_atan(-1), atan(-1)));
...
START_TEST(atan_NAN) {
  // NAN
  ck_assert(!precision_check(s21_atan(S21_NAN), atan(S21_NAN)));
...
START_TEST(atan_S21_INF) {
  // 1.570796
  ck_assert(!precision_check(s21_atan(S21_INF), atan(S21_INF)));
