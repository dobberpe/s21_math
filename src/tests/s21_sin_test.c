...
START_TEST(sin_09) {
  for (double i = 0.9; i > -1; i -= 0.1) {
    ck_assert(!precision_check(s21_sin(i), sin(i)));
...
START_TEST(sin_1) {
  ck_assert(!precision_check(s21_sin(1), sin(1)));
  ck_assert(!precision_check(s21_sin(-1), sin(-1)));
...
START_TEST(sin_NAN) {
  // NAN
  ck_assert(!precision_check(s21_sin(S21_NAN), sin(S21_NAN)));
...
START_TEST(sin_INFINITY) {
  // -NAN
  ck_assert(!precision_check(s21_sin(S21_INF), sin(S21_INF)));
...
START_TEST(s21_sin_max_double) {
  // 0.004962
  ck_assert(!precision_check(s21_sin(S21_double_MAX), sin(S21_double_MAX)));
...
START_TEST(s21_sin_min_double) {
  // 0.0
  ck_assert(!precision_check(s21_sin(S21_double_MIN), sin(S21_double_MIN)));
