...
START_TEST(s21_ceil_max_double) {
  // S21_double_MAX
  ck_assert(!precision_check(s21_ceil(S21_double_MAX), ceil(S21_double_MAX), false));
...
START_TEST(s21_ceil_min_double) {
  // 1.0
  ck_assert(!precision_check(s21_ceil(S21_double_MIN), ceil(S21_double_MIN), false));
