...
START_TEST(s21_acos_max_double) {
  // NAN
  ck_assert(!precision_check(s21_acos(S21_double_MAX), acos(S21_double_MAX), false));
...
START_TEST(s21_acos_min_double) {
  // 1.570796
  ck_assert(!precision_check(s21_acos(S21_double_MIN), acos(S21_double_MIN), false));
